...
import 'package:beep/widgets/error_widget.dart';
...
Future<void> startGui(List<Client> clients, SharedPreferences store) async {
  ...
  ErrorWidget.builder = (details) => beepErrorWidget(details);
  runApp(BeepApp(clients: clients, pincode: pin, store: store));
}
