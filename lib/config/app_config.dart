...
abstract class AppConfig {
  static String _applicationName = 'beep';
  static String get applicationName => _applicationName;
  static String? _applicationWelcomeMessage;
  static String? get applicationWelcomeMessage => _applicationWelcomeMessage;
  static String _defaultHomeserver = 'ms.beep.gov.pk';
  ...
  static String _privacyUrl =
      'https://github.com/krille-chan/beep/blob/main/PRIVACY.md';
  static String get privacyUrl => _privacyUrl;
  static const String enablePushTutorial =
      'https://github.com/krille-chan/beep/wiki/Push-Notifications-without-Google-Services';
  ...
  static const String sourceCodeUrl =
      'https://github.com/krille-chan/beep';
  static const String supportUrl =
      'https://github.com/krille-chan/beep/issues';
  static const String changelogUrl =
      'https://github.com/krille-chan/beep/blob/main/CHANGELOG.md';
  static final Uri newIssueUrl = Uri(
    scheme: 'https',
    host: 'github.com',
    path: '/krille-chan/beep/issues/new',
  );
